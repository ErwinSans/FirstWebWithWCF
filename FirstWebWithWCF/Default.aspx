...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div>
        ...
        <asp:Button ID="Button3" runat="server" Text="Multiply" BackColor="#0099FF" 
            Font-Bold="true" Font-Size="Medium" ForeColor="White" Width="62px" OnClick="Button3_Click"/>
        <asp:Button ID="Button4" runat="server" Text="Divide" BackColor="#0099FF" 
            Font-Bold="true" Font-Size="Medium" ForeColor="White" Width="62px" OnClick="Button4_Click"/>

    </div>
    <br />
        <div><div style="color:blue; font-size:medium; font-weight:bolder">
